...
class PromptContractTests(unittest.TestCase):
    ...
    def test_codex_router_is_task_only_and_routes_security_categories(self) -> None:
        ...
        self.assertIn("Keep the user informed with concise, factual phase checkpoints", definition)
        self.assertIn("Do not expose hidden reasoning, raw child output", definition)
        self.assertIn("Keep the user informed with concise, factual phase checkpoints", prompt)
