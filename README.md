...
| --- | --- | --- |
| `agents.atlas` | `openrouter/z-ai/glm-5.3` | `openrouter/deepseek/deepseek-v4-flash-0731` |
| `agents.codex-router` | `openrouter/z-ai/glm-5.3` | `openrouter/deepseek/deepseek-v4-flash-0731` |
| `agents.content-aware-research` | `openrouter/nousresearch/hermes-4-405b` | `openrouter/deepseek/deepseek-v4-pro-0813` |
| `agents.explore` | `openrouter/z-ai/glm-5.3` | `openrouter/deepseek/deepseek-v4-flash-0731` |
| `agents.hephaestus` | `subscription-gateway/gpt-5.6-terra` | `openrouter/deepseek/deepseek-v4-pro-0813` |
| `agents.librarian` | `openrouter/deepseek/deepseek-v4-flash-0731` | `openrouter/deepseek/deepseek-v4-flash-0731` |
| `agents.metis` | `openrouter/google/gemini-3.1-pro-preview` | `openrouter/deepseek/deepseek-v4-flash-0731` |
| `agents.momus` | `subscription-gateway/gpt-5.6-sol-review` | `openrouter/deepseek/deepseek-v4-pro-0813` |
| `agents.multimodal-looker` | `openrouter/google/gemini-3.1-pro-preview` | `openrouter/deepseek/deepseek-v4-flash-0731` |
| `agents.oracle` | `subscription-gateway/gpt-5.6-sol` | `openrouter/deepseek/deepseek-v4-pro-0813` |
| `agents.prometheus` | `openrouter/z-ai/glm-5.3` | `openrouter/deepseek/deepseek-v4-flash-0731` |
| `agents.sisyphus` | `openrouter/z-ai/glm-5.3` | `openrouter/deepseek/deepseek-v4-flash-0731` |
| `agents.sisyphus-junior` | `openrouter/deepseek/deepseek-v4-flash-0731` | `openrouter/deepseek/deepseek-v4-flash-0731` |
| `categories.agentic-deep-kimi` | `openrouter/moonshotai/kimi-k2.7-code` | `openrouter/deepseek/deepseek-v4-flash-0731` |
| `categories.arch-review` | `subscription-gateway/gpt-5.6-sol-review` | `openrouter/deepseek/deepseek-v4-pro-0813` |
| `categories.artistry` | `openrouter/google/gemini-3.1-pro-preview` | `openrouter/deepseek/deepseek-v4-flash-0731` |
| `categories.bug-hunt` | `openrouter/z-ai/glm-5.3` | `openrouter/deepseek/deepseek-v4-flash-0731` |
